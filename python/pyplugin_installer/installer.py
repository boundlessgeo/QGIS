...
from PyQt4.QtCore import Qt, QObject, QSettings, QDir, QUrl, QSettings, QFileInfo, QFile
from PyQt4.QtGui import QMessageBox, QLabel, QFrame, QApplication, QFileDialog
...
class QgsPluginInstaller(QObject):
    ...
    def installFromZipFile(self):
        ...
        filePath = QFileDialog.getOpenFileName(iface.mainWindow(),
                                               self.tr('Open file'),
                                               lastDirectory,
