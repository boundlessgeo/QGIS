...
QgsExpressionContextScope* QgsExpressionContextUtils::globalScope()
{
  ...
  scope->addVariable( QgsExpressionContextScope::StaticVariable( "qgis_short_version", QString( "%1.%2" ).arg( QGis::QGIS_VERSION_INT / 10000 ).arg( QGis::QGIS_VERSION_INT / 100 % 100 ), true ) );
  ...
  scope->addVariable( QgsExpressionContextScope::StaticVariable( "qgis_locale", QgsApplication::locale(), true ) );
