...
static void setTitleBarText_( QWidget & qgisApp )
{
  ...
  caption += QString( " for Boundless Desktop");
...
void QgisApp::createStatusBar()
{
  ...
  mMagnifierWidget->updateMagnification( QgsSettings().value( "/qgis/magnifier_factor_default", 1.0 ).toDouble() );
...
void QgisApp::setTheme( const QString& theThemeName )
{
  ...
  */
  ...
  mActionInstallFromZip->setIcon( QgsApplication::getThemeIcon( "/mActionInstallPluginFromZip.svg" ) );
...
void QgisApp::initLayerTreeView()
{
  ...
  bool otfTransformAutoEnable = QgsSettings().value( "/Projections/otfTransformAutoEnable", true ).toBool();
...
QString QgisApp::crsAndFormatAdjustedLayerUri( const QString &uri, const QStringList &supportedCrs, const QStringList &supportedFormats ) const
{
  ...
  QString lastImageEncoding = QgsSettings().value( "/qgis/lastWmsImageEncoding", "image/png" ).toString();
...
void QgisApp::toggleMapTips( bool enabled )
{
  ...
  QgsSettings().setValue( "/qgis/enableMapTips", mMapTipsVisible );
...
void QgisApp::removeLayer()
{
  ...
  bool promptConfirmation = QgsSettings().value( "qgis/askToDeleteLayers", true ).toBool();
...
void QgisApp::activateDeactivateLayerRelatedActions( QgsMapLayer* layer )
{
  ...
  if ( !layer )
  {
    ...
    mActionIdentify->setEnabled( QgsSettings().value( "/Map/identifyMode", 0 ).toInt() != 0 );
